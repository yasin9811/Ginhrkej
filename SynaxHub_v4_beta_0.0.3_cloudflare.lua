...
local C11_ACCESS_API_URL = "https://reward-dover-seen-forgotten.trycloudflare.com"
...
if not applyC11AccessCheck() then
    -- ========================================================================
    -- C11 SYNAX PROFESSIONAL ACCESS RESTRICTION UI
    -- UI replacement only. Access/API logic above remains unchanged.
    -- ========================================================================
    ...
    local banReason = tostring(C11AccessState.Reason or "Blacklisted")
    local banDuration = C11AccessState.ExpiresAt and tostring(C11AccessState.ExpiresAt) or "Permanent"
...
local function ExecuteScript()
    ...
    UpdateInfoTitle.Text = "Synax Hub Update (beta - 0.0.2)"
