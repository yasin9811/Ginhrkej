...
local function ExecuteScript()
    ...
    DeveloperDesc.Text = "Merhaba " .. LocalPlayer.DisplayName .. ", biliyorsun Script ücretsiz.\nGeliştiriciyi desteklemek için profilini takip edebilirsin."
