...
-- ============================================================================
-- SYNAX HUB GLOBAL LANGUAGE SYSTEM • BETA
-- 18 languages. Some secondary strings intentionally remain imperfect during
-- beta; missing translations safely fall back to English.
-- ============================================================================
local LanguageState = {
    Current = "English"
}
...
local L = {
    English = {
        ["Dashboard"]="Dashboard", ["Information"]="Information", ["Farm"]="Farm",
        ["Auto Eat"]="Auto Eat", ["Combat"]="Combat", ["ESP"]="ESP",
        ["Staff"]="Staff", ["Extra"]="Extra", ["Settings"]="Settings",
        ["Language"]="Language", ["Select Language"]="Select Language",
        ["Current Language"]="Current Language", ["Beta"]="Beta",
        ["Enabled"]="Enabled", ["Disabled"]="Disabled", ["ON"]="ON", ["OFF"]="OFF",
        ["Staff Monitor"]="Staff Monitor", ["No staff detected."]="No staff detected.",
        ["Staff ESP"]="Staff ESP", ["Staff Alerts"]="Staff Alerts",
        ["Farm Protection"]="Farm Protection", ["Leave on Staff Join"]="Leave on Staff Join",
        ["C11 SYNAX ACCESS"]="C11 SYNAX ACCESS", ["Blacklist / Access"]="Blacklist / Access",
        ["AUTHORIZED"]="AUTHORIZED", ["DENIED"]="DENIED", ["Access API"]="Access API",
        ["ONLINE"]="ONLINE", ["OFFLINE"]="OFFLINE", ["Restriction"]="Restriction",
        ["None"]="None", ["RE-CHECK C11 ACCESS"]="RE-CHECK C11 ACCESS",
        ["Webhook Logger"]="Webhook Logger", ["Webhook Info"]="Webhook Info",
    ...
    Turkish = {
        ["Dashboard"]="Kontrol Paneli", ["Information"]="Bilgi", ["Farm"]="Farm",
        ["Auto Eat"]="Otomatik Yeme", ["Combat"]="Savaş", ["ESP"]="ESP",
        ["Staff"]="Yetkili", ["Extra"]="Ekstra", ["Settings"]="Ayarlar",
        ["Language"]="Dil", ["Select Language"]="Dil Seç", ["Current Language"]="Mevcut Dil",
        ["Beta"]="Beta", ["Enabled"]="Aktif", ["Disabled"]="Devre Dışı",
        ["ON"]="AÇIK", ["OFF"]="KAPALI", ["Staff Monitor"]="Yetkili Takibi",
        ["No staff detected."]="Yetkili algılanmadı.", ["Staff ESP"]="Yetkili ESP",
        ["Staff Alerts"]="Yetkili Uyarıları", ["Farm Protection"]="Farm Koruması",
        ["Leave on Staff Join"]="Yetkili Gelince Ayrıl", ["C11 SYNAX ACCESS"]="C11 SYNAX ERİŞİM",
        ["Blacklist / Access"]="Blacklist / Erişim", ["AUTHORIZED"]="YETKİLİ",
        ["DENIED"]="REDDEDİLDİ", ["Access API"]="Erişim API", ["ONLINE"]="ÇEVRİMİÇİ",
        ["OFFLINE"]="ÇEVRİMDIŞI", ["Restriction"]="Kısıtlama", ["None"]="Yok",
        ["RE-CHECK C11 ACCESS"]="C11 ERİŞİMİ TEKRAR KONTROL ET",
        ["Webhook Logger"]="Webhook Logger", ["Anti AFK (Prevent Kick)"]="Anti AFK (Atılmayı Önle)",
        ["Noclip (Walk Through Walls)"]="Noclip (Duvarlardan Geç)",
        ["Mobile HUD Editor"]="Mobil HUD Düzenleyici",
        ["Enable Mobile HUD Editor Overlay"]="Mobil HUD Düzenleyiciyi Aç",
        ["Teleport to Black Market"]="Black Market'e Işınlan"
    },
    German = {["Dashboard"]="Dashboard",["Information"]="Information",["Settings"]="Einstellungen",["Language"]="Sprache",["Select Language"]="Sprache wählen",["Current Language"]="Aktuelle Sprache",["Farm"]="Farm",["Combat"]="Kampf",["Players"]="Spieler",["Enabled"]="Aktiv",["Disabled"]="Deaktiviert",["Staff"]="Team",["Extra"]="Extra"},
    French = {["Dashboard"]="Tableau de bord",["Information"]="Informations",["Settings"]="Paramètres",["Language"]="Langue",["Select Language"]="Choisir la langue",["Current Language"]="Langue actuelle",["Farm"]="Farm",["Combat"]="Combat",["Staff"]="Staff",["Extra"]="Extra"},
    Spanish = {["Dashboard"]="Panel",["Information"]="Información",["Settings"]="Ajustes",["Language"]="Idioma",["Select Language"]="Seleccionar idioma",["Current Language"]="Idioma actual",["Farm"]="Farm",["Combat"]="Combate",["Staff"]="Personal",["Extra"]="Extra"},
    Italian = {["Dashboard"]="Pannello",["Information"]="Informazioni",["Settings"]="Impostazioni",["Language"]="Lingua",["Select Language"]="Seleziona lingua",["Current Language"]="Lingua attuale",["Farm"]="Farm",["Combat"]="Combattimento",["Staff"]="Staff",["Extra"]="Extra"},
    Portuguese = {["Dashboard"]="Painel",["Information"]="Informações",["Settings"]="Configurações",["Language"]="Idioma",["Select Language"]="Selecionar idioma",["Current Language"]="Idioma atual",["Farm"]="Farm",["Combat"]="Combate",["Staff"]="Staff",["Extra"]="Extra"},
    ["Brazilian Portuguese"] = {["Dashboard"]="Painel",["Information"]="Informações",["Settings"]="Configurações",["Language"]="Idioma",["Select Language"]="Escolher idioma",["Current Language"]="Idioma atual",["Farm"]="Farm",["Combat"]="Combate",["Staff"]="Equipe",["Extra"]="Extra"},
    Russian = {["Dashboard"]="Панель",["Information"]="Информация",["Settings"]="Настройки",["Language"]="Язык",["Select Language"]="Выбрать язык",["Current Language"]="Текущий язык",["Farm"]="Фарм",["Combat"]="Бой",["Staff"]="Персонал",["Extra"]="Дополнительно"},
    Ukrainian = {["Dashboard"]="Панель",["Information"]="Інформація",["Settings"]="Налаштування",["Language"]="Мова",["Select Language"]="Вибрати мову",["Current Language"]="Поточна мова",["Farm"]="Фарм",["Combat"]="Бій",["Staff"]="Персонал",["Extra"]="Додатково"},
    Polish = {["Dashboard"]="Panel",["Information"]="Informacje",["Settings"]="Ustawienia",["Language"]="Język",["Select Language"]="Wybierz język",["Current Language"]="Bieżący język",["Farm"]="Farm",["Combat"]="Walka",["Staff"]="Ekipa",["Extra"]="Dodatki"},
    Dutch = {["Dashboard"]="Dashboard",["Information"]="Informatie",["Settings"]="Instellingen",["Language"]="Taal",["Select Language"]="Taal kiezen",["Current Language"]="Huidige taal",["Farm"]="Farm",["Combat"]="Gevecht",["Staff"]="Team",["Extra"]="Extra"},
    Arabic = {["Dashboard"]="لوحة التحكم",["Information"]="المعلومات",["Settings"]="الإعدادات",["Language"]="اللغة",["Select Language"]="اختر اللغة",["Current Language"]="اللغة الحالية",["Farm"]="فارم",["Combat"]="قتال",["Staff"]="الطاقم",["Extra"]="إضافي"},
    Indonesian = {["Dashboard"]="Dasbor",["Information"]="Informasi",["Settings"]="Pengaturan",["Language"]="Bahasa",["Select Language"]="Pilih Bahasa",["Current Language"]="Bahasa Saat Ini",["Farm"]="Farm",["Combat"]="Pertarungan",["Staff"]="Staf",["Extra"]="Ekstra"},
    Japanese = {["Dashboard"]="ダッシュボード",["Information"]="情報",["Settings"]="設定",["Language"]="言語",["Select Language"]="言語を選択",["Current Language"]="現在の言語",["Farm"]="ファーム",["Combat"]="戦闘",["Staff"]="スタッフ",["Extra"]="その他"},
    Korean = {["Dashboard"]="대시보드",["Information"]="정보",["Settings"]="설정",["Language"]="언어",["Select Language"]="언어 선택",["Current Language"]="현재 언어",["Farm"]="파밍",["Combat"]="전투",["Staff"]="스태프",["Extra"]="추가"},
    Chinese = {["Dashboard"]="控制面板",["Information"]="信息",["Settings"]="设置",["Language"]="语言",["Select Language"]="选择语言",["Current Language"]="当前语言",["Farm"]="刷取",["Combat"]="战斗",["Staff"]="管理",["Extra"]="其他"},
    Hindi = {["Dashboard"]="डैशबोर्ड",["Information"]="जानकारी",["Settings"]="सेटिंग्स",["Language"]="भाषा",["Select Language"]="भाषा चुनें",["Current Language"]="वर्तमान भाषा",["Farm"]="फार्म",["Combat"]="लड़ाई",["Staff"]="स्टाफ",["Extra"]="अतिरिक्त"}
}
...
local function SetLocalizedText(object, original)
    if object then
        object:SetAttribute("SynaxOriginalText", original)
        object.Text = Translate(original)
    end
end
...
local function ExecuteScript()
    ...
    UpdateInfoTitle.Text = "Synax Hub Update (beta - 0.0.5)"
    ...
    LanguageTitle.Text = "GLOBAL LANGUAGE • BETA"
    ...
    LanguageInfo.Text = "18 languages available. Beta translations may contain minor inconsistencies."
    ...
    for i, item in ipairs(SupportedLanguages) do
        if item.Name == LanguageState.Current then
            LanguageIndex = i
            break
        end
    end

    local LanguageButton = CreateButton(SettingsPage, "🌐  Select Language", function() end)

    -- Replace the temporary callback with a compact cycle selector.
    LanguageButton.Text = "🌐  " .. SupportedLanguages[LanguageIndex].Flag .. "  " .. SupportedLanguages[LanguageIndex].Name

    local function ApplyLanguage()
        local item = SupportedLanguages[LanguageIndex]
        LanguageState.Current = item.Name
        LanguageCard.Text = item.Name
        LanguageButton.Text = "🌐  " .. item.Flag .. "  " .. item.Name

        -- Translate registered controls created by the standard UI helpers.
        for _, obj in ipairs(MainGui:GetDescendants()) do
            if obj:IsA("TextLabel") or obj:IsA("TextButton") then
                local original = obj:GetAttribute("SynaxOriginalText")
                if original then
                    if obj:IsA("TextButton") and string.sub(original, 1, 2) == "🌐" then
                        -- language selector is handled separately
                    else
                        obj.Text = (obj:IsA("TextButton") and string.sub(original, 1, 2) == "  ")
                            and "  " .. Translate(string.sub(original, 3))
                            or Translate(original)
                    end
                end
            end
        end
    ...
    LanguageButton.MouseButton1Click:Connect(function()
        ...
        if LanguageIndex > #SupportedLanguages then
            LanguageIndex = 1
        end
        ApplyLanguage()
    end)
